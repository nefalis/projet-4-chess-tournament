...
class ReportController:
    ...
    def display_all_tournament(self):
        tournaments = self.tournament_controller.display_tournament()
        print("rc l28 get tournament")
        pprint(self.tournament_controller.display_tournament)
    ...
    """ fonction pour afficher le rapport d'un tournoi """ 
    def display_tournament_report(self):   
        ...
        # selected_tournament = TournamentView.select_tournament(self)
        # if selected_tournament:
        #     # Affichage des informations de base sur le tournoi
        #     print(Panel(f"Informations sur le tournoi : {selected_tournament.name_tournament}\n"
        #                 f"Date de début : {selected_tournament.date_start}\n"
        #                 f"Date de fin : {selected_tournament.date_finish}\n"
        #                 f"Ville du tournoi : {selected_tournament.town_tournament}",
        #                 title="Rapport du Tournoi"))

        #     # Affichage des rounds et des matchs associés
        #     for round_number, matches in selected_tournament.rounds.items():
        #         print(Panel(f"Round {round_number}", title="Détails du Round"))
